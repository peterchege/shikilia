            ...
            <select class="form-control" name="operator" required="required">
	              ...
	              <option value="100">Above 25kg</option>
					...
					<div class="form-group">
						...
						<input class="form-control" type="time" name="ci" required="required" value="<?= ((isset($_GET['ci']))? $_GET['ci']:'');?>">

						<br>
					<div class="form-group">
						<label for= "name">Check out time:</label>
						<input class="form-control" type="time" name="co" required="required" value="<?= ((isset($_GET['ci']))? $_GET['co']:'');?>">
