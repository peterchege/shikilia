...
<!-- button for modial  can be copied anywhere on the page -->
...
<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
 ...
 <!-- this part of the code should be copied at the base of page.... after </html>
<!-- Modal -->
