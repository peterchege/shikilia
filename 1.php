    ...
    <head>
       ...
       <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" >
        ...
        <!-- The following icons can be replaced with your own, they are used by desktop and mobile browsers -->
            <link rel="shortcut icon" href="img/shikilia_icon.png">
            <link rel="apple-touch-icon" href="img/shikilia_icon.png" sizes="57x57">
            <link rel="apple-touch-icon" href="img/shikilia_icon.png" sizes="72x72">
            <link rel="apple-touch-icon" href="img/shikilia_icon.png" sizes="76x76">
            <link rel="apple-touch-icon" href="img/shikilia_icon.png" sizes="114x114">
            <link rel="apple-touch-icon" href="img/shikilia_icon.png" sizes="120x120">
            <link rel="apple-touch-icon" href="img/shikilia_icon.png" sizes="144x144">
            <link rel="apple-touch-icon" href="img/shikilia_icon.png" sizes="152x152">
            <link rel="apple-touch-icon" href="img/shikilia_icon.png" sizes="180x180">
        <!-- END Icons -->
