...
//show wanted fields
 ...
 (array(
 "first_name","id_number","phone_number","barcode","shelf_number","description","checkin_date","checkout_date",
...
$pdocrud->tableColFormatting("checkout_status", "replace",array("not cleared" =>"<i class=\"fa fa-thumbs-down\" aria-hidden=\"true\"></i>not cleared "));
 ...
 //records per page  ( assuming to get 20 clients per day for easy math calculations) you can adjust this
