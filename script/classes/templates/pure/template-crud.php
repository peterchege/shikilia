                        ...
                        <div class="row">
                            ...
                            <?php if ($settings["deleteMultipleBtn"]) { ?>
                                <div class="col-xs-1 no-padding">
                                    <a title="<?php echo $lang["delete_selected"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-delete-all  btn btn-primary" href="javascript:;" data-action="delete_selected" data-obj-key="<?php echo $objKey; ?>">
                    ...
                    <div class="col-sm-6">
                        <ul class="pdocrud-export-options">
                            <?php if ($settings["printBtn"]) { ?>
                                <li><a title="<?php echo $lang["print"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-export btn btn-default" href="javascript:;" data-action="exporttable" data-export-type="print" data-objkey="<?php echo $objKey; ?>">
                            ...
                            if ($settings["csvBtn"]) {
                                ?> 
                                <li>
                                    <a title="<?php echo $lang["csv"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-export btn btn-default" href="javascript:;" data-action="exporttable" data-export-type="csv" data-objkey="<?php echo $objKey; ?>">
                            ...
                            if ($settings["pdfBtn"]) {
                                ?>
                                <li><a title="<?php echo $lang["pdf"]; ?>"class="pdocrud-actions pdocrud-button pdocrud-button-export btn btn-default" href="javascript:;" data-action="exporttable" data-export-type="pdf" data-objkey="<?php echo $objKey; ?>">
                            ...
                            if ($settings["excelBtn"]) { ?>
                                <li><a title="<?php echo $lang["excel"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-export btn btn-default" href="javascript:;" data-action="exporttable" data-export-type="excel" data-objkey="<?php echo $objKey; ?>">
                                        <i class="fa fa-file" aria-hidden="true"></i>
                                            <?php echo $lang["excel"]; ?>
                                    </a>
                                </li>
