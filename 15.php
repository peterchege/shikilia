...
$pdocrud->tableHeading("Make a correction on the List of customer  and the luggage  checked out");
 
$pdocrud->crudTableCol(array(
"first_name","id_number","phone_number","shelf_number","barcode","description","category","amount_paid","payment_status","checkout_time","checkout_date","checkout_status","credit_note_status","credit_note_available"));
...
//dropdowns
 ...
 $pdocrud->fieldDataBinding("checkout_status", array
 (
 "cleared" =>"cleared",
 "not cleared"=>"not cleared"), "", "","array"); 
