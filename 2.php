...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
 ...
 <a href="#" onclick="$('#myModal').modal({'backdrop': 'static'});"
  class="btn btn-danger">CALCULATOR </a>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
 ...
 <object data=http://localhost/shikilia/chege/original.php width="500" height="500"> <embed src=http://localhost/shikilia/chege/original.php  width="500" height="500"> </embed> </object>  
