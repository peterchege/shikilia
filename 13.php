...
$pdocrud->tableHeading("Make a correction on the List of customer  and the luggage  checked in");
 
$pdocrud->crudTableCol(array(
"shelf_number","first_name","id_number","phone_number","barcode","description","category","state","payment_status","checkin_time","checkin_date","estimated_checkout_time"));
