...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
 ...
 <li><a href="15.php"> Make a correction  in(check out) </a></li>
  ...
  <!-- QUICK MENU ENDS HERE  --> 
	     ...
	     <center> Use search bar on the right to search for barcode and the one on the table to search using id/name/phone number etc</center>
</section>
            <!-- END Key Features -->
...
$pdocrud->addFilter("barcodeFilter", "", "barcode", "text");
...
//polishing up the code
 ...
 $pdocrud->tableHeading("Quick Search for luggages using barcode.(use buttons on action column to navigate.) ");
